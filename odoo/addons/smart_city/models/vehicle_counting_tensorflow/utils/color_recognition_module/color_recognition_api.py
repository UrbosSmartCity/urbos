...
from odoo.addons.smart_city.models.vehicle_counting_tensorflow.utils.color_recognition_module import color_histogram_feature_extraction
from odoo.addons.smart_city.models.vehicle_counting_tensorflow.utils.color_recognition_module import knn_classifier
from odoo.addons.smart_city.models.vehicle_counting_tensorflow.utils.image_utils import crop_image

# current_path = os.getcwd()
root_path = config['root_path']
current_path = os.path.join(root_path,"addons/smart_city/models/vehicle_counting_tensorflow")
