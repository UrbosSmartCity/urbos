...
class Camera(models.Model):
    ...
    def _getImg(self):
        ...
        self.img = '<img src="'+base_url+'/smart_city/'+str(self.id)+'" style="with:100%;" alt="this is camera source"/>'
    ...
    def get_cant_vehicles(self):
        ...
        # initialize .csv
        with open(os.path.join(root_path,'addons/smart_city/models/vehicle_counting_tensorflow/traffic_measurement.csv'), 'w') as f:
            writer = csv.writer(f)
            csv_line = \
        ...
        MODEL_NAME = os.path.join(config['root_path'],'addons/smart_city/models/vehicle_counting_tensorflow/ssd_mobilenet_v1_coco_2018_01_28')
        ...
        PATH_TO_LABELS = os.path.join(config['root_path'],'addons/smart_city/models/vehicle_counting_tensorflow/data', 'mscoco_label_map.pbtxt')
